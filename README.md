...
<div align="center">
  <img src="preview-img/simple-bank-simulator.jpg" alt="Bank simulator login screen" width=600>
</div>
...
<div align="center">
  <img src="preview-img/todo-app.jpg" alt="Todo app task list" width=600>
</div>
...
### Custom pizza order - [Live View](https://nostrand.github.io/fullstack-js-trainee-bootcamp/custom-pizza-order/src/index.html)
A dynamic pizza ordering app that allows users to select pizza sizes, add extra ingredients, and customize their tip amount. The app automatically calculates the subtotal, tip (both suggested and custom), and the total cost.

<div align="center">
  <img src="preview-img/custom-pizza-order.jpg" alt="Custom pizza order website." width=600>
</div>
